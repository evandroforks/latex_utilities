...
% Option `hyperfootnotes' has already been used...` because `bigfoot` already set it to false.
%
% Currently you need to edit `bigfoot/bigfoot.sty` and comment the line 61 to fix this:
