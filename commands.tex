...
\makeatletter
    ...
    {%
        ...
        \ifismemoirloaded
            \ifisabntexloaded
                \let\oldABNTEXchapterupperifneeded\ABNTEXchapterupperifneeded
                \renewcommand{\ABNTEXchapterupperifneeded}[1]{\oldABNTEXchapterupperifneeded{##1} \protect\goToSummaryText}
            \else
        ...
        \else
            \@ifundefined{Chapterformat}{\message{Chapterformat patch for addGoToSummary could NOT
                ...
                \let\oldChapterformat\Chapterformat
                \renewcommand{\Chapterformat}[2]{\oldChapterformat{##1} \protect\goToSummaryText}%
            }
        \fi
    }
    ...
    {%
        ...
        \ifismemoirloaded
            \ifisabntexloaded
                \let\ABNTEXchapterupperifneeded\oldABNTEXchapterupperifneeded
            \else
        ...
        \else
            \@ifundefined{Chapterformat}{\message{Chapterformat patch for removeGoToSummary could NOT
                be applied because there is no Chapterformat command available!^^J}}{%
                \let\Chapterformat\oldChapterformat%
            }
        \fi
    }
\makeatother
