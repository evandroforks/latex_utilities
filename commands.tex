...
\newcommand{\mythesispreliminarylistname}{Short Table of Contents}
\newlistof{thesispreliminarycontents}{tpc}{\mythesispreliminarylistname}
...
\newlistentry{thesispreliminarycounter}{tpc}{0}
...
\renewcommand{\thethesispreliminarycounter}{\arabic{thesispreliminarycounter}}
...
\newcommand{\addtothesispreliminarycontent}[1]
{%
    \refstepcounter{thesispreliminarycounter}
    \addcontentsline{tpc}{thesispreliminarycounter}{\protect\numberline{\thethesispreliminarycounter}#1}\par
}



% Customizing inline enumerate with enumitem still not working?
% https://tex.stackexchange.com/questions/103086/customizing-inline-enumerate-with-enumitem-still-not-working
...
% https://tex.stackexchange.com/questions/211097/for-the-inline-enumerate-controlling-the-item-spacing
\newcommand{\wordslistlabled}[1]
{
    \begin{inlinelist}[label=\arabic*.,itemjoin=\hspace{5pt},afterlabel=\hspace{3pt}]#1\end{inlinelist}
}
\newcommand{\wordslistunlabled}[1]{\begin{inlinelist}[label=,itemjoin=\hspace{1pt}]#1\end{inlinelist}}
