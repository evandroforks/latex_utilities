    ...
    {%
        ...
        \ifismemoirloaded
            \ifisabntexloaded
                ...
                \renewcommand{\ABNTEXchapterupperifneeded}[1]{\oldAddGoToABNTEXchapterupperifneeded{##1} \protect\goToSummaryText}
            \else
                \let\oldAddGoToprintchaptertitle\printchaptertitle
                \renewcommand{\printchaptertitle}[1]{\oldAddGoToprintchaptertitle{##1} \protect\goToSummaryText}
            \fi
        \else
            \@ifundefined{Chapterformat}{\message{Chapterformat patch for addGoToSummary could NOT
                ...
                \renewcommand{\Chapterformat}[2]{\oldAddGoToChapterformat{##1} \protect\goToSummaryText}%
            }
        \fi
    }
