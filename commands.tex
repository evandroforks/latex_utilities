...
%
% Use \addGoToSummary to turn it on, and
% \removeGoToSummary to turn off the `[Go To Top]` label.
%
...
% https://tex.stackexchange.com/questions/388045/how-can-the-go-to-summary-be-fixed-so-the-sectionsomesome-more-does-not-thr
\makeatletter
